...
const themModal = document.querySelector(".customize-theme");
...
// open modal
const openThemModal = () => {
    themModal.style.display = "grid";
};
// closes modal
const closeThemModal = (e) => {
    if (e.target.classList.contains("customize-theme")) {
        themModal.style.display = "none";
    }
};

// close modal
themModal.addEventListener("click", closeThemModal);
